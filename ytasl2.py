...
# Play ASL videos in a single persistent OpenCV window
...
note = ttk.Label(root, text="Videos should be placed in gifs/ as A.mp4, B.mp4, ...", wraplength=400, justify="center", font=("Segoe UI", 9))
note.pack(pady=10)
